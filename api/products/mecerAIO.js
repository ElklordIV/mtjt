document.addEventListener('DOMContentLoaded', () => {
    ...
    (async () => {
        try {
            ...
            const response1 = await fetch('/api/products/category/Mecer All In One');
            const products1 = await response1.json();

            // Fetch products from the second category
            const response2 = await fetch('/api/products/category/Mecer Mini PC');
