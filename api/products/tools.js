...
// Function to fetch products for the Tools page
async function fetchToolsProducts() {
    try {
        // Fetch products specifically for the Tools page
        const response = await fetch('/api/products/tools');
        if (response.ok) {
            const products = await response.json();
            displayProducts(products);
        } else {
            console.error('Failed to fetch Lenovo products');
        }
    } catch (error) {
